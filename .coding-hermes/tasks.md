...
- Tick-551 residue folded into this tick's commit: its `.gitreins/tasks.yaml` completion record. Note: the -dogfood tick's worker appended DF-HERMES-CANOPY-45..48 mid-tick (parallel writer; rows intact, count 374→378 during this tick).
