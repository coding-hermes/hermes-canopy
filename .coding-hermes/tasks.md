...
|| 🟡 GAP-004 | DuckDB card storage: 848 lines delivered (duckdb_repo.go + duckdb_store.go + 6 tests). 5/6 tests pass. Archive duplicate-key bug needs fix. | Medium | 3 | card, db | ++architecture | | | |
